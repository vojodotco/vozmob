...
It is possible to configure the default VoIP Number settings at either the global level (by going to /admin/settings/voipnumberfield) or on a field-by-field basis. 
